...
export default async function SignupPage() {
  ...
  return (
    <div className="signup-page min-h-screen bg-[#f0f4f8]">
      <div className="mx-auto flex min-h-screen max-w-md flex-col px-6 py-12">
        ...
        <p className="mt-8 text-center text-sm opacity-90" style={{ color: "#002d56" }}>
          <Link
            href="/"
            className="isd-brand-link font-medium underline rounded focus:outline-none focus:ring-2 focus:ring-[#fdb913] focus:ring-offset-2"
            style={{ color: "#002d56" }}
          >
            {t("backToHome")}
          </Link>
